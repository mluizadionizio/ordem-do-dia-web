...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-950 via-red-900 to-red-800">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl p-8 w-full max-w-sm flex flex-col items-center gap-5">
        {/* Logo */}
        ...
        <div className="flex w-full rounded-xl border border-gray-200 overflow-hidden">
          <button
            ...
            className={`flex-1 py-2 text-sm font-medium transition
              ${tab === "google" ? "bg-red-900 text-white" : "bg-white text-gray-500 hover:bg-gray-50"}`}
          >
            Google
          </button>
          <button
            ...
            className={`flex-1 py-2 text-sm font-medium transition
              ${tab === "email" ? "bg-red-900 text-white" : "bg-white text-gray-500 hover:bg-gray-50"}`}
          >
            Email e senha
          </button>
        </div>
